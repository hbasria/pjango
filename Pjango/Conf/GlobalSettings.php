...
# Subject-line prefix for email messages send with Pjango.core.mail.mail_admins
...
# A secret key for this particular Pjango installation. Used in secret-key
# hashing algorithms. Set this in your settings, or Pjango will complain
# loudly.
...
# `None` will make Pjango use the operating system's default temporary directory
...
$GLOBALS['SETTINGS']['FILE_ALLOWED_MIME_TYPES'] = array(
		'image/jpeg',
		'image/pjpeg',
		'image/png',
		'image/x-png',
...
$GLOBALS['SETTINGS']['FILE_ALLOWED_EXTENSIONS'] = array('.jpg','.jpeg','.gif','.png','.flv');
...
# http://docs.Pjangoproject.com/en/dev/ref/templates/builtins/#now
...
#from Pjango import get_version
...
$GLOBALS['SETTINGS']['SESSION_ENGINE'] = 'Pjango.contrib.sessions.backends.db';  # The module to store session data
...
# The cache backend to use.  See the docstring in Pjango.core.cache for the
# possible values.
...
$GLOBALS['SETTINGS']['LOGGING'] = array(
	'handler'        => 'file',
	'ident'          => 'ident',	
    'name'           => sprintf('log/out_%s.log', date('d-m-Y')),
