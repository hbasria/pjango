...
$urlpatterns = patterns('',
	...
	array('^admin/pages/Post/(?P<id>\d+)/$', 'pjango.contrib.post.views.admin_addchange'),
	array('^admin/pages/Post/(?P<id>\d+)/edit/$', 'pjango.contrib.post.views.admin_addchange'),
	array('^admin/pages/Post/(?P<id>\d+)/edit/status/$', 'pjango.contrib.post.views.admin_changestatus'),
